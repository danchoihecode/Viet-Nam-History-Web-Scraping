...
public class MergeSite {
	...
	private static final String[] ATTRIBUTES = { "diaChi", "khoiLap", "phanLoai", "suKienLienQuan", "nhanVatLienQuan",
			"leHoiLienQuan", "mieuTa", "anh", "url" };

	public static void main(String[] args) {
		// Đường dẫn tới file input và output
		String inputFile = "file\\site-concatenated.json";
		String outputFile = "file\\site.json";
