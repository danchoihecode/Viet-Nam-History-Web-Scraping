...
public class MergeDynasty {

	private static final String[] ATTRIBUTES = {"thoiGian", "nguoiSangLap", "thuDo", "lanhDaoQuocGia", "mieuTa", "tenNuoc"};

	public static void main(String[] args) {
		// Đường dẫn tới file input và output
		String inputFile = "file\\period-concatenated.json";
		String outputFile = "file\\period.json";
	...
	private static void mergeAttributes(JsonObject targetObject, JsonObject sourceObject, int nguon) {
		for (String attribute : ATTRIBUTES) {
			if (sourceObject.has(attribute)) {
				...
				if (attribute.equals("lanhDaoQuocGia") || attribute.equals("tenNuoc")) {
